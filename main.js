 ...
 */
let counter = (function counter(n){
 	let count = 0;
 	 return function (num) {
 ...
 * #3
 *
 * Создайте функцию myPow(a, b, myPrint). Внутри реализуйте рекурсию для подсчета результата 
 возведения числа a в степень b.
 ...
 */
let myUniqNums = [1, 1, 2, 3, 4, 5, 6, 7];
let myUniqStrings = ['Bob', 'Kate', 'Jhon', 'Tom', 'Jhon', 'Kate', 'Tom', 'Bob', 'Jhon', 'Tom'];
let myUniq = (arr) => {
  let set = new Set();
...
console.log(myUniq(myUniqNums));
console.log(myUniq(myUniqStrings));
